...
public class TC13 {
	...
	public static void main(String[] args) {
	   ...
	   // launch the url
		...
		driver.findElement(By.xpath("//a[@title='Unsere Partnershops']")).click();
		//To get the title of the page
		String title  = driver.getTitle();
		System.out.println(title);
		//verify that launched page exist or not
		if(driver.getTitle().contains("Möbel günstig online kaufen in einem der Partnershops von moebel.de"))
		{
