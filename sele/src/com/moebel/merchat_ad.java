...
public class merchat_ad {
 ...
 public static void main(String[] args) throws InterruptedException {
   ...
   //String t = driver.findElement(By.className("bifi-title")).getText();
   String t = driver.getPageSource();
  //System.out.println(t);
   
   //String t1= null;
   if(t.contains("merchantads")){
    
    System.out.println("Merchant add found");
   }
   else{
   
    System.out.println("oops.. you are in blacklist IP");
   }
 }
